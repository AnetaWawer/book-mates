        ...
        <Grid container columnSpacing={{ xs: 2, sm: 4, md: 12 }}  sx={{ height: { xs:'600px',sm:'250px' ,md:'230px' ,lg:'180px' } , display:'wrap'} }>
            <Grid item md={1}>
                <ButtonBase sx={{ width: 96, height: 128 }}>
                    <Img alt="book-cover" src={topic.book.pictureUrl} onClick={() =>navigate("/books/" + topic.book.id)} />
                </ButtonBase>
            </Grid>
            <Grid  item  sm container>
                ...
                <Grid item xs={8} container direction="column">
                    <Grid item >
                        <Typography variant="h6" color="inherit"  onClick={ () => navigate("/books/" + topic.book.id+ "/topics")} sx={{cursor:"pointer", color:"inherit"}} >
                            {topic.title}
                        </Typography>
                        <Typography variant="subtitle2">
                            <span> {topic.creationTime} przez  {topic.author.username} </span>
                        </Typography>
                    </Grid>
                </Grid>
                <Grid item >
